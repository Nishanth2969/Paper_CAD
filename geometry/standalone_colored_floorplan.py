...
def main():
    ...
    input_image = "data/image_samples/test_4.jpeg"  # Change to your input image path
    output_image = "output/image_tests/standalone_colored_test4.png"  # Change to your desired output path
